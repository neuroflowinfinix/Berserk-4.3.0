...
static inline void ShiftToBadCaptures(MoveList* moves, int idx) {
...
static inline Move PopGoodCapture(MoveList* moves, int idx) {
...
static inline Move PopQuiet(MoveList* moves, int idx) {
...
static inline Move PopBadCapture(MoveList* moves) {
